...
export const LAB_LABELS = Object.freeze({
  ...
  riddles: {
    title: 'قوافي',
    note: 'بيت أو مثل في كل سطر، وفيه ــــ مكان الفراغ.',
    hint: `أربعة أجزاء مفصولة بـ | : النص | الجواب | ${RIDDLE_DECOYS} بدائل مفصولة بفواصل | المصدر. السطر بلا ــــ يعني أن الفراغ في آخره.`,
