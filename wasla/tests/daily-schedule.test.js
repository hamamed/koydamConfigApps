...
test('each weekday carries one game, and Friday the marathon', () => {
  ...
  assert.equal(kindForDate('2026-09-19'), 'scramble', 'Saturday');
  assert.equal(kindForDate('2026-09-20'), 'bubbles', 'Sunday');
  assert.equal(kindForDate('2026-09-21'), 'groups', 'Monday');
