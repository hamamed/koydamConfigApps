...
#
#   sudo DOMAIN=bdc.civictrust.ma EMAIL=admin@civictrust.ma bash deploy/setup.sh
#
...
DOMAIN="${DOMAIN:-bdc.civictrust.ma}"
EMAIL="${EMAIL:-}"
...
# 3200 Fortnite, 8080 Brawl, 8090 the platform panel. 3300 is this one's.
PORT="${PORT:-3300}"
SKIP_TLS="${SKIP_TLS:-0}"
