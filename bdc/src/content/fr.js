...
export default {
  ...
  landing: {
    ...
    roadmap: [
      ...
      { status: 'next', title: 'Fiches entreprises',
        body: 'Le pendant des fiches acheteurs : ce qu’une entreprise remporte, chez qui, et à quels montants.' },
      { status: 'next', title: 'Recherche en texte intégral',
        body: 'Une recherche qui classe par pertinence plutôt que de filtrer, sur l’objet et sur les articles.' },
      ...
      { status: 'later', title: 'Vue publique de transparence',
        body: 'Des pages consultables sans compte sur les attributions et les acheteurs.' },
    ],
