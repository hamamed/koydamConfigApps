...
export default {
  ...
  landing: {
    ...
    roadmap: [
      ...
      { status: 'next', title: 'Company profiles',
        body: 'The counterpart to buyer profiles: what a company wins, from whom, and at what amounts.' },
      { status: 'next', title: 'Full-text search',
        body: 'Search that ranks by relevance rather than filtering, over the objet and the articles.' },
      ...
      { status: 'later', title: 'A public transparency view',
        body: 'Pages on awards and buyers that can be read without an account.' },
    ],
