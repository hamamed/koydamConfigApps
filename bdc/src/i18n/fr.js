...
export default {
  ...
  'article.actions': 'Marché',
  'article.buy': 'Acheter',
  'article.sheetHint': 'Fiche complète, recherche marché et demande de prix',
  'article.sheet': 'Fiche article',
  'article.specs': 'Caractéristiques',
  'article.market': 'Chercher sur le marché marocain',
  'article.market.it': 'Spécialistes informatique et électronique',
  'article.market.books': 'Librairies',
  'article.market.tools': 'Outillage et matériaux',
  'article.market.photo': 'Photo et vidéo',
  'article.market.general': 'Places de marché générales',
  'article.marketHint': 'Recherche effectuée sur {query} — le libellé du marché, débarrassé des mentions administratives.',
  'article.noQuery': 'Ce libellé ne contient rien de cherchable en boutique.',
  'article.rfq': 'Demande de prix',
  'article.rfqHint': 'À copier tel quel dans un e-mail à un fournisseur. L’estimation de l’administration n’y figure pas.',
  'article.copy': 'Copier',
  'article.copied': 'Copié.',
  'article.lot': 'Lot',
  'article.estimation': 'Estimation',
  'article.delay': 'Délai d’exécution',
  'article.place': 'Lieu d’exécution',
  'article.rfq.subject': 'Demande de prix — avis d’achat',
  'article.rfq.deadline': 'Date limite de l’avis',
  'article.rfq.ask': 'Merci de nous communiquer votre meilleur prix unitaire HT, le délai de livraison et la durée de garantie.',
