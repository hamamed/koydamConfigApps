...
export const config = Object.freeze({
  ...
  scraper: Object.freeze({
    ...
    // The appel d'offres listing, a PRADO search on the main portal. The
    // /bdc/ paths this was forked from address the bons de commande portal —
    // a different procedure entirely, served by its own application.
    listingPath: process.env.SCRAPER_LISTING_PATH || '/index.php?page=entreprise.EntrepriseAdvancedSearch&AllCons',
  ...
  mail: Object.freeze({
    ...
    from: process.env.MAIL_FROM || 'marches@civictrust.ma',
