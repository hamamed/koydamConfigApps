...
export function tableStatements(dialect) {
  ...
  return [
    ...
    `CREATE TABLE IF NOT EXISTS consultations (
      ...
      -- The appel d'offres portal addresses a consultation by two values, not
      -- one: refConsultation identifies it, orgAcronyme says which buying
      -- entity published it, and the detail URL needs both.
      org_acronyme TEXT,
...
export function additiveColumns() {
  return [
    ...
    // The buying entity's acronym on the appel d'offres portal, without which
    // a consultation's own detail page cannot be addressed.
    { table: 'consultations', column: 'org_acronyme', definition: 'TEXT' },
  ]
}
export const SCHEMA_VERSION = '2026-09-07.017'
